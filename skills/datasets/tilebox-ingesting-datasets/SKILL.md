...
7. **Keep source normalization in the converter.** Every converter validates its source and owns provider-specific parsing and STAC 1.1 normalization, including mapping provider processing-level fields to canonical `processing:level` values.
